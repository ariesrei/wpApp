...
final class thesis {
	public $version = '2.5';
	public $changelog = 'http://diythemes.com/thesis/rtfm/changelog/v25/';
	...
	private function compatibility() {
		...
		$this->woocommerce = new thesis_woocommerce;
//		$this->sensei = new thesis_sensei;
		$this->wp_customize = is_user_logged_in() && (!empty($_REQUEST['wp_customize']) || $GLOBALS['pagenow'] === 'customize.php') ? true : false;
		$this->caching = defined('W3TC') || defined('WPCACHEHOME') ? true : false;
