	...
	protected function class_options() {
		...
		$options = array(
			...
			'bing' => array(
				...
				'tooltip' => sprintf(__('%1$s <a href="%2$s" target="_blank" rel="noopener">Bing Webmaster Tools</a>. Copy and paste the unique <code>content=&quot;[this is what you want to copy]&quot;</code> value into this field.', 'thesis'), $tooltip, 'http://www.bing.com/toolbox/webmasters/')));
		if ($this->override)
