...
About this class:
=================
Use the methods in this class as a shortcut for creating CSS-based design options. This class also contains methods
that can assist in delivering refined CSS (ie, in the css_variables() method of a Skin).

TODO: Document the methods
*/
class thesis_skin_css_tools {
	public function __construct() {
		global $thesis;
		if (empty($thesis->environment)) return;
		add_action('init', array($this, 'init'), 12);	// Timing ensures Fonts are fully loaded and available for use in CSS options
	}
	...
	private function properties() {
		global $thesis;
		return array(
			'font-family' => array_merge(array('' => 'Select a font:'), $thesis->skin->fonts->select),
			'font-weight' => array(
			...
			'font' => array(
				...
				'fields' => array(
					...
					'line-height' => array(
						...
						'tooltip' => sprintf(__('You can specify a line height directly, or you can allow the Thesis typography %1$s to generate your line heights according to <a href="%2$s" target="_blank" rel="noopener">Golden Ratio Typography</a>.', 'thesis'), $thesis->api->base['api'], esc_url('http://pearsonified.com/2011/12/golden-ratio-typography.php'))),
					'font-weight' => array(
						'type' => 'select',
