...
class thesis_skin_fonts_google {
	...
	public function __construct($options) {
		...
		add_action('hook_head', array($this, 'webfont_loader'));		// front-end filter for anything that needs to be in the <head>
	...
	*/
	...
	public function webfont_loader() {
		...
		echo
			...
			"wf.src = ('https:' == document.location.protocol ? 'https' : 'http') + '://cdnjs.cloudflare.com/ajax/libs/webfont/1.6.27/webfontloader.js';",
